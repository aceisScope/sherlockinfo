...
@interface TwitterIndexViewController()
...
@implementation TwitterIndexViewController
...
- (void)directReload
{
    NSString* jsonString = [self pathForJSONWithFileName:[NSString stringWithFormat:@"%@%@",self.title,@".json"]];
...
- (void)fail:(ASIHTTPRequest*)request
{
	...
	UIAlertView *alert = [[UIAlertView alloc] initWithTitle:nil message:@"Unable to download twitter rss. Please check if you are connected to internet." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil];
	[alert show];	
	[alert release];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    TwitterDetailedViewController *detailViewController = [[TwitterDetailedViewController alloc]initWithDict:[self.jsonDictArray objectAtIndex:indexPath.row]]; 
//    detailViewController.tweetDict = [NSDictionary dictionaryWithDictionary:[self.jsonDictArray objectAtIndex:indexPath.row]];
//    NSLog(@"%@",[[self.jsonDictArray objectAtIndex:indexPath.row] objectForKey:@"user"]);
