...
-(void) adjustWithString:(NSString*)content withImage:(NSString*) url andDate:(NSString*) date andAvatar:(NSString*)profileUrl andName:(NSString*)name
{
    ...
    CGSize size = CGSizeMake(300,3200);
    ...
    [self.weiboLabel setFrame:CGRectMake(MARGIN_TO_LEFT, MARGIN_TO_TOP, labelsize.width, labelsize.height*1.3)];
...
{    
    ...
    NSString * date  = [dict objectForKey:@"pubDate"];
    
    [self adjustWithString:text withImage:nil andDate:date andAvatar:nil andName:nil];
}
