 ...
 */
#define SHKTwitterConsumerKey		@"IM8BNH7kqLPBmoSG5qJA"
#define SHKTwitterSecret			@"eJYazKCL4WWTRHtjRZulg10Xgvq7nXT3xQXWb7k"
#define SHKTwitterCallbackUrl		@"http://example.com/oauth" // You need to set this if using OAuth, see note above (xAuth users can skip it)
...
#define SHKBitLyLogin				@"o_540jnj7j5u"
#define SHKBitLyKey					@"R_0676b86c27690b23fbc5a040edbf8028"
